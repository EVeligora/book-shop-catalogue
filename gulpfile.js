...
gulp.task('default', gulp.series(gulp.parallel('pug', 'sass', 'imageSync', 'fontsSync', 'fontsConvert', 'jsConcatLibs', 'jsConcatComponents', 'jsSync', 'watch', 'browser-sync', "svgSpriteBuild")));
